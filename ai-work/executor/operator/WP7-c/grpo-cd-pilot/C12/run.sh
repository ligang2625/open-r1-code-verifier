...
STALE_RUNNING_GUARD_COMMIT="e6622a40c0449477079710e0fe875e216278e13c"
SUPERSEDED_CHECKPOINT_ID="C11"
SUPERSEDED_CHECKPOINT_COMMIT="418cc1138b9c748726876ae6c53822773578151b"
SUPERSEDED_RESULT_CODE_COMMIT="e6622a40c0449477079710e0fe875e216278e13c"
SUPERSEDED_SCRIPT_SHA="d390dcd95c0f48702dbb14014b4efb6c3d848634d2c258fa74d30c1a6503af84"
...
FAILED_C10_SCRIPT_SHA="06499d2b00b0799f4b277b130d095e498ec1fafe5753eb862c33824735739b49"
FAILED_C10_EVIDENCE_SHA="13a612f0d7fa6c8d471065dd7fe890570acc08483708e7933d5cb30875086396"
FAILED_C10_STATUS_SHA="a5e45837a2959db847f7e67a915d0ecaddd47f943af2af5fa6453be497faabca"
FAILED_C10_LOG_SHA="4e2e12af753f1da6f220a145df7c43d8464b8295123ede2ff837d3d97abf9c33"
UNEXECUTED_C9_CHECKPOINT_COMMIT="792f637f34ccabebbc61fde61bd861f20887f217"
UNEXECUTED_C9_RESULT_CODE_COMMIT="78d4aebd36d916db3c8d160dcfa89f5425affc22"
UNEXECUTED_C9_SCRIPT_SHA="bae1e5ec8f0b4c29b86401e547ced8fc818b1b90af6c7d0d6b4bde708d15dcfa"
CADENCE_COMMIT="78d4aebd36d916db3c8d160dcfa89f5425affc22"
FAIL_CLOSED_COMMIT="b58667f4ff1e34e1e1e13e2f78fef21cb118fdf9"
INVALID_C8_CHECKPOINT_ID="C8"
INVALID_C8_CHECKPOINT_COMMIT="32ab2697b33c9a211c37c78f0871808de069b658"
INVALID_C8_RESULT_CODE_COMMIT="9e55b4175e5d86804d1ce182e04489e4b5f99a87"
INVALID_C8_SCRIPT_SHA="18bbbaddbe00a5c0f610a49b65307d583172eea5c32381cd97be7444fbb21c06"
INVALID_C8_EVIDENCE_SHA="def49dcb2d838e8ff8a740250ad392a3dee34c54774d808c3c4b82630451b594"
INVALID_C8_STATUS_SHA="53c234e5e8472b6ac51c1ae1cab3fe06fad053beb8ebfd8977b010655bfdd3c3"
INVALID_C8_LOG_SHA="b9052153a341093732d8dee9d312bb3437cfe8a12ccafeb3537200fccc4e0b90"
...
SCRIPT_REL="ai-work/executor/operator/WP7-c/grpo-cd-pilot/C12/run.sh"
...
INVALID_C8_PUBLIC_RUN_NAME="C-public-grpo-pilot100-seed42"
INVALID_C8_HIDDEN_RUN_NAME="D-hidden-grpo-pilot100-seed42"
...
INVALID_C8_PUBLIC_RUN="$PILOT_ROOT/$INVALID_C8_PUBLIC_RUN_NAME"
INVALID_C8_HIDDEN_RUN="$PILOT_ROOT/$INVALID_C8_HIDDEN_RUN_NAME"
...
SUPERSEDED_OP_ROOT="$ARTIFACT_ROOT/operator/$STAGE_ID/$PLAN_COMMIT/$GATE_ID/$SUPERSEDED_CHECKPOINT_ID"
FAILED_C10_OP_ROOT="$ARTIFACT_ROOT/operator/$STAGE_ID/$PLAN_COMMIT/$GATE_ID/C10"
FAILED_C10_EVIDENCE_FILE="$FAILED_C10_OP_ROOT/operator-evidence.json"
FAILED_C10_STATUS_FILE="$FAILED_C10_OP_ROOT/status"
FAILED_C10_LOG_FILE="$FAILED_C10_OP_ROOT/terminal.log"
FAILED_C10_POSTCHECK_FILE="$FAILED_C10_OP_ROOT/postcheck-summary.json"
UNEXECUTED_C9_OP_ROOT="$ARTIFACT_ROOT/operator/$STAGE_ID/$PLAN_COMMIT/$GATE_ID/C9"
INVALID_C8_OP_ROOT="$ARTIFACT_ROOT/operator/$STAGE_ID/$PLAN_COMMIT/$GATE_ID/$INVALID_C8_CHECKPOINT_ID"
INVALID_C8_EVIDENCE_FILE="$INVALID_C8_OP_ROOT/operator-evidence.json"
INVALID_C8_STATUS_FILE="$INVALID_C8_OP_ROOT/status"
INVALID_C8_LOG_FILE="$INVALID_C8_OP_ROOT/terminal.log"
INVALID_C8_POSTCHECK_FILE="$INVALID_C8_OP_ROOT/postcheck-summary.json"
...
files = []
for run_name in ("C-public-grpo-pilot100-retry1-seed42", "D-hidden-grpo-pilot100-retry1-seed42"):
...
payload = {
    ...
    "superseded_checkpoint": {
        "checkpoint_id": "C11",
        "operator_checkpoint_commit": "418cc1138b9c748726876ae6c53822773578151b",
        ...
        "execution_state": "certified_unexecuted_before_C12",
    },
    "failed_c10_preflight": {
        "checkpoint_id": "C10",
        "operator_checkpoint_commit": "d9af548d49cc8f781984f31ea70817e4afa9f1b1",
        ...
        "operator_evidence_sha256": "13a612f0d7fa6c8d471065dd7fe890570acc08483708e7933d5cb30875086396",
        "status_sha256": "a5e45837a2959db847f7e67a915d0ecaddd47f943af2af5fa6453be497faabca",
        "terminal_log_sha256": "4e2e12af753f1da6f220a145df7c43d8464b8295123ede2ff837d3d97abf9c33",
        "execution_state": "preflight_failed_before_training",
    },
    "unexecuted_c9_ancestor": {
        "checkpoint_id": "C9",
        "operator_checkpoint_commit": "792f637f34ccabebbc61fde61bd861f20887f217",
    ...
    "preserved_invalid_c8": {
        "checkpoint_id": "C8",
        "operator_checkpoint_commit": "32ab2697b33c9a211c37c78f0871808de069b658",
        ...
        "operator_evidence_sha256": "def49dcb2d838e8ff8a740250ad392a3dee34c54774d808c3c4b82630451b594",
        "status_sha256": "53c234e5e8472b6ac51c1ae1cab3fe06fad053beb8ebfd8977b010655bfdd3c3",
        "terminal_log_sha256": "b9052153a341093732d8dee9d312bb3437cfe8a12ccafeb3537200fccc4e0b90",
        "failure_reason": "Piston tunnel failed during C8 Public; Public became infrastructure-invalid from step 36 and Hidden never started",
        "first_infrastructure_failure_step": 36,
        "infrastructure_failure_rows": 498,
        "sandbox_error_status_rows": 495,
    },
...
[[ "$PARENT_COMMIT" == "$RESULT_CODE_COMMIT" ]] || fail_preflight "C12 checkpoint parent is not the hard-interruption recovery result-code commit"
RESULT_CODE_PARENT="$(git -C "$REPO_ROOT" rev-parse "$RESULT_CODE_COMMIT^" 2>/dev/null)" || fail_preflight "cannot resolve hard-interruption recovery result-code parent"
[[ "$RESULT_CODE_PARENT" == "$SUPERSEDED_CHECKPOINT_COMMIT" ]] || fail_preflight "hard-interruption recovery result-code parent is not superseded C11"
C11_PARENT="$(git -C "$REPO_ROOT" rev-parse "$SUPERSEDED_CHECKPOINT_COMMIT^" 2>/dev/null)" || fail_preflight "cannot resolve C11 checkpoint parent"
[[ "$C11_PARENT" == "$STALE_RUNNING_GUARD_COMMIT" && "$STALE_RUNNING_GUARD_COMMIT" == "$SUPERSEDED_RESULT_CODE_COMMIT" ]] || fail_preflight "C11 parent is not the superseded stale-running guard commit"
STALE_GUARD_PARENT="$(git -C "$REPO_ROOT" rev-parse "$STALE_RUNNING_GUARD_COMMIT^" 2>/dev/null)" || fail_preflight "cannot resolve stale-running guard parent"
[[ "$STALE_GUARD_PARENT" == "$FAILED_C10_CHECKPOINT_COMMIT" ]] || fail_preflight "stale-running guard parent is not the executed-preflight C10 checkpoint"
C10_PARENT="$(git -C "$REPO_ROOT" rev-parse "$FAILED_C10_CHECKPOINT_COMMIT^" 2>/dev/null)" || fail_preflight "cannot resolve C10 checkpoint parent"
[[ "$C10_PARENT" == "$RECOVERY_HARDENING_COMMIT" && "$RECOVERY_HARDENING_COMMIT" == "$FAILED_C10_RESULT_CODE_COMMIT" ]] || fail_preflight "C10 parent is not the certified recovery-hardening commit"
RECOVERY_PARENT="$(git -C "$REPO_ROOT" rev-parse "$RECOVERY_HARDENING_COMMIT^" 2>/dev/null)" || fail_preflight "cannot resolve recovery-hardening parent"
[[ "$RECOVERY_PARENT" == "$UNEXECUTED_C9_CHECKPOINT_COMMIT" ]] || fail_preflight "recovery-hardening parent is not the unexecuted C9 checkpoint"
C9_PARENT="$(git -C "$REPO_ROOT" rev-parse "$UNEXECUTED_C9_CHECKPOINT_COMMIT^" 2>/dev/null)" || fail_preflight "cannot resolve C9 checkpoint parent"
[[ "$C9_PARENT" == "$CADENCE_COMMIT" && "$CADENCE_COMMIT" == "$UNEXECUTED_C9_RESULT_CODE_COMMIT" ]] || fail_preflight "C9 parent is not the certified 10-step cadence commit"
CADENCE_PARENT="$(git -C "$REPO_ROOT" rev-parse "$CADENCE_COMMIT^" 2>/dev/null)" || fail_preflight "cannot resolve 10-step cadence parent"
[[ "$CADENCE_PARENT" == "$FAIL_CLOSED_COMMIT" ]] || fail_preflight "10-step cadence parent is not the certified fail-closed commit"
FAIL_CLOSED_PARENT="$(git -C "$REPO_ROOT" rev-parse "$FAIL_CLOSED_COMMIT^" 2>/dev/null)" || fail_preflight "cannot resolve fail-closed parent"
[[ "$FAIL_CLOSED_PARENT" == "$INVALID_C8_CHECKPOINT_COMMIT" ]] || fail_preflight "fail-closed parent is not the preserved C8 checkpoint"
if ! "$PY" - "$REPO_ROOT" "$UNEXECUTED_C9_CHECKPOINT_COMMIT" "$RECOVERY_HARDENING_COMMIT" "$FAILED_C10_CHECKPOINT_COMMIT" "$STALE_RUNNING_GUARD_COMMIT" "$SUPERSEDED_CHECKPOINT_COMMIT" "$RESULT_CODE_COMMIT" "$REPORT_REL" <<'PY_RESULT_SCOPE'
import hashlib
import subprocess
import sys
from pathlib import Path
repo=Path(sys.argv[1])
c9, recovery, c10, stale_guard, c11, result, report=sys.argv[2:]

def status(a: str, b: str) -> list[str]:
    return subprocess.run(
        ["git", "-C", str(repo), "diff", "--name-status", a, b],
        check=True, capture_output=True, text=True,
    ).stdout.splitlines()

expected_recovery=[
    "M\tsrc/code_verifier/training/grpo.py",
    "M\ttests/integration/test_wp7a_grpo_integration.py",
    "M\ttests/unit/training/test_grpo.py",
]
if status(c9, recovery) != expected_recovery:
    raise SystemExit("C12 recovery-hardening business scope changed")
c10_script="ai-work/executor/operator/WP7-c/grpo-cd-pilot/C10/run.sh"
if status(recovery, c10) != [f"M\t{report}", f"A\t{c10_script}"]:
    raise SystemExit("executed-preflight C10 checkpoint scope changed")
if status(c10, stale_guard) != [
    "M\tsrc/code_verifier/training/grpo.py",
    "M\ttests/unit/training/test_grpo.py",
]:
    raise SystemExit("superseded stale-running guard scope changed")
c11_script="ai-work/executor/operator/WP7-c/grpo-cd-pilot/C11/run.sh"
if status(stale_guard, c11) != [f"M\t{report}", f"A\t{c11_script}"]:
    raise SystemExit("superseded C11 checkpoint scope changed")
if status(c11, result) != [
    "M\tsrc/code_verifier/training/grpo.py",
    "M\ttests/unit/training/test_grpo.py",
]:
    raise SystemExit("C12 hard-interruption recovery result-code scope changed")
for commit, script, expected_sha in (
    (c10, c10_script, "06499d2b00b0799f4b277b130d095e498ec1fafe5753eb862c33824735739b49"),
    (c11, c11_script, "d390dcd95c0f48702dbb14014b4efb6c3d848634d2c258fa74d30c1a6503af84"),
):
    mode_line=subprocess.run(
        ["git", "-C", str(repo), "ls-tree", commit, "--", script],
        check=True, capture_output=True, text=True,
    ).stdout.strip()
    if not mode_line.startswith("100755 "):
        raise SystemExit(f"historical operator script mode changed: {script}")
    content=subprocess.run(
        ["git", "-C", str(repo), "show", f"{commit}:{script}"],
        check=True, capture_output=True,
    ).stdout
    if hashlib.sha256(content).hexdigest() != expected_sha:
        raise SystemExit(f"historical operator script SHA changed: {script}")
PY_RESULT_SCOPE
then
  fail_preflight "C12 result-code/checkpoint provenance scope validation failed"
fi
...
if status != [f"M\t{report}", f"A\t{script}"]:
    raise SystemExit(f"C12 checkpoint scope is not exactly report+script: {status}")
mode_line = subprocess.run(
    ["git", "-C", str(repo), "ls-tree", head, "--", script],
    check=True, capture_output=True, text=True,
).stdout.strip()
if not mode_line.startswith("100755 "):
    raise SystemExit("tracked C12 operator script is not executable")
...
PY_SCOPE
then
  fail_preflight "C12 checkpoint scope/append-only provenance failed"
fi
...
pos = text.rfind("checkpoint_id: C12")
if pos < 0:
    raise SystemExit("C12 checkpoint block is missing")
start = text.rfind("execution_checkpoint:", 0, pos)
end = text.find("```", pos)
if start < 0 or end < 0:
    raise SystemExit("C12 checkpoint block is malformed")
block = text[start:end]
def field(name: str) -> str:
    match = re.search(rf"^\s*{re.escape(name)}:\s*(.+?)\s*$", block, flags=re.MULTILINE)
    if not match:
        raise SystemExit(f"C12 checkpoint field missing: {name}")
...
PY_META
)" || fail_preflight "cannot parse C12 checkpoint metadata"
...
[[ "$CHECKPOINT_MODE" == "portable_target" && "$CHECKPOINT_GATE" == "$GATE_ID" ]] || fail_preflight "C12 checkpoint handoff/gate mismatch"
[[ "$CHECKPOINT_RESTART" == "trainer_checkpoint" && "$CHECKPOINT_STATUS" == "awaiting_operator" ]] || fail_preflight "C12 checkpoint restart/status mismatch"
[[ "$CHECKPOINT_RESULT" == "$RESULT_CODE_COMMIT" && "$CHECKPOINT_PLAN" == "$PLAN_COMMIT" ]] || fail_preflight "C12 checkpoint source provenance mismatch"
[[ "$ACCEPTED_PRIOR_EVIDENCE" == "$PRIOR_EVIDENCE_SHA" && "$CHECKPOINT_PRIOR_COMMIT" == "$PRIOR_CHECKPOINT_COMMIT" ]] || fail_preflight "C12 accepted-C5 provenance mismatch"
[[ "$CHECKPOINT_SUPERSEDES_ID" == "$SUPERSEDED_CHECKPOINT_ID" && "$CHECKPOINT_SUPERSEDES_COMMIT" == "$SUPERSEDED_CHECKPOINT_COMMIT" ]] || fail_preflight "C12 supersession provenance mismatch"
SCRIPT_SHA="$(sha256sum "$REPO_ROOT/$SCRIPT_REL" | awk '{print $1}')"
[[ "$SCRIPT_SHA" == "$EXPECTED_SCRIPT_SHA" ]] || fail_preflight "tracked C12 operator script SHA mismatch"
...
if (public.max_steps, hidden.max_steps, public.save_steps, hidden.save_steps) != (100, 100, 10, 10):
    raise SystemExit("pilot cadence is not 100 steps / save 10")
pair_sha, components = _paired_definition(public, hidden, seed=42, parent_sft=parent)
expected_components = {
    "paired_definition_version": 2,
    "paired_public_config_hash": "da543a9ac2719076fd81696dbcb98f1df9c9254adc9e9f519569b3b0d2e09dac",
    "paired_hidden_config_hash": "5036e0aa8be941f145f52e08269e808948f091c80d5d0972ef50326417934658",
    "paired_public_dataset_hash": "94ef48888d2b2edaa0080b9b412c274ada692c9546fe135572d48ab20fd49223",
    "paired_hidden_dataset_hash": "79af3c2a3742e0cda8d02901a07241afce12a54c0b6d334e3012bcd0b69f77f7",
}
if components != expected_components:
    raise SystemExit("portable pilot pair components differ from control-plane certification")
if pair_sha != "bb8a733b2f6b9519d6e9c9de087461a975ba830f6c132a8f06120881576b512f":
    raise SystemExit("portable pilot pair SHA differs from control-plane certification")
...
if [[ -e "$SUPERSEDED_OP_ROOT" ]]; then
  fail_preflight "superseded C11 operator root exists even though C11 was never executed"
fi
if [[ -e "$UNEXECUTED_C9_OP_ROOT" ]]; then
  fail_preflight "C9 operator root exists even though C9 was never executed"
fi
printf '[%s] superseded C11/C9 unexecuted PASS: c11_operator_root_absent=true c9_operator_root_absent=true\n' "$(date -u +%Y-%m-%dT%H:%M:%SZ)" >>"$LOG_FILE"

if ! "$PY" - "$FAILED_C10_EVIDENCE_FILE" "$FAILED_C10_STATUS_FILE" "$FAILED_C10_LOG_FILE" "$FAILED_C10_POSTCHECK_FILE" "$PUBLIC_RUN" "$HIDDEN_RUN" <<'PY_FAILED_C10'
import hashlib
import json
import sys
from pathlib import Path

evidence_path, status_path, log_path, postcheck_path, public_run, hidden_run = map(Path, sys.argv[1:7])
...
expected_sha = {
    evidence_path: "13a612f0d7fa6c8d471065dd7fe890570acc08483708e7933d5cb30875086396",
    status_path: "a5e45837a2959db847f7e67a915d0ecaddd47f943af2af5fa6453be497faabca",
    log_path: "4e2e12af753f1da6f220a145df7c43d8464b8295123ede2ff837d3d97abf9c33",
}
for path, expected in expected_sha.items():
    if not path.is_file() or path.is_symlink() or sha(path) != expected:
        raise SystemExit(f"executed-preflight C10 operator artifact changed: {path.name}")
if status_path.read_text(encoding="utf-8").strip() != "125":
    raise SystemExit("executed-preflight C10 status is not 125")
if postcheck_path.exists():
    raise SystemExit("executed-preflight C10 unexpectedly produced postcheck evidence")
e = json.loads(evidence_path.read_text(encoding="utf-8"))
expected = {
    "version": 1,
    "stage_id": "WP7-c",
    ...
    "command_rc": 125,
    "postcheck_rc": 125,
    "gate_status": "preflight_failed",
    "note": "preserved invalid C8 infrastructure-failure evidence or preserved invalid Public run changed",
}
if not isinstance(e, dict) or any(e.get(key) != value for key, value in expected.items()):
    raise SystemExit("executed-preflight C10 provenance changed")
if public_run.exists() or hidden_run.exists():
    raise SystemExit("retry1 run namespace exists even though C10 failed before training")
print("executed_preflight_c10=PASS retry1_absent=true")
PY_FAILED_C10
then
  fail_preflight "executed-preflight C10 evidence changed or retry1 namespace is not fresh"
fi

if ! "$PY" - "$INVALID_C8_EVIDENCE_FILE" "$INVALID_C8_STATUS_FILE" "$INVALID_C8_LOG_FILE" "$INVALID_C8_POSTCHECK_FILE" "$INVALID_C8_PUBLIC_RUN" "$INVALID_C8_HIDDEN_RUN" <<'PY_SUPERSEDED'
import hashlib
import json
import sys
from pathlib import Path
...
expected_sha = {
    evidence_path: "def49dcb2d838e8ff8a740250ad392a3dee34c54774d808c3c4b82630451b594",
    status_path: "53c234e5e8472b6ac51c1ae1cab3fe06fad053beb8ebfd8977b010655bfdd3c3",
    log_path: "b9052153a341093732d8dee9d312bb3437cfe8a12ccafeb3537200fccc4e0b90",
}
for path, expected in expected_sha.items():
    if not path.is_file() or path.is_symlink() or sha(path) != expected:
        raise SystemExit(f"preserved invalid C8 operator artifact changed: {path.name}")
if status_path.read_text(encoding="utf-8").strip() != "2":
    raise SystemExit("preserved invalid C8 status is not the certified command failure")
if postcheck_path.exists():
    raise SystemExit("preserved invalid C8 unexpectedly produced postcheck evidence")
e = json.loads(evidence_path.read_text(encoding="utf-8"))
expected = {
    "version": 1,
    "stage_id": "WP7-c",
...
if not isinstance(e, dict) or any(e.get(key) != value for key, value in expected.items()):
    raise SystemExit("preserved invalid C8 failure provenance changed")
formal_pair = e.get("formal_pair")
if not isinstance(formal_pair, dict) or formal_pair.get("paired_definition_sha256") != "b889cf144b787854c73a6b97c9a26d1a0378dee9ba1e822b965c1ef85c637be2":
    raise SystemExit("preserved invalid C8 portable pair identity changed")
if formal_pair.get("public_run_name") != "C-public-grpo-pilot100-seed42" or formal_pair.get("hidden_run_name") != "D-hidden-grpo-pilot100-seed42":
    raise SystemExit("preserved invalid C8 run names changed")
if hidden_run.exists():
    raise SystemExit("preserved invalid C8 Hidden run unexpectedly exists")
required_public = {
    public_run / "run.json": "557f880a199ef6ddcfa5127d85d8cb1e98a68c00fe982423dc79c0f0c260d59e",
    public_run / "rewards.jsonl": "4a3dba109be0dfa51949e61383ef35e2f59f4bc084580b80b5e84142f7e22226",
    public_run / "checkpoints/adapter_model.safetensors": "41d01287ef7c21494bfb0e13910f7238a45802068c658631b68ef80dcd89b32b",
}
for path, expected in required_public.items():
    if not path.is_file() or path.is_symlink() or sha(path) != expected:
        raise SystemExit(f"preserved invalid C8 Public artifact changed: {path.name}")
metadata = json.loads((public_run / "run.json").read_text(encoding="utf-8"))
for key, value in {
    "run_id": "C-public-grpo-pilot100-seed42",
    "reward_mode": "public",
    "status": "completed",
    "global_step": 100,
    "git_commit": "32ab2697b33c9a211c37c78f0871808de069b658",
    "paired_definition_version": 2,
    "paired_definition_sha256": "b889cf144b787854c73a6b97c9a26d1a0378dee9ba1e822b965c1ef85c637be2",
}.items():
    if metadata.get(key) != value:
        raise SystemExit(f"preserved invalid C8 Public metadata changed: {key}")
rows=[]
for line in (public_run / "rewards.jsonl").read_text(encoding="utf-8").splitlines():
    if not line.strip():
        raise SystemExit("preserved invalid C8 Public rewards contains a blank row")
    value=json.loads(line)
    if not isinstance(value, dict):
        raise SystemExit("preserved invalid C8 Public reward row is not an object")
    rows.append(value)
if len(rows) != 800:
    raise SystemExit("preserved invalid C8 Public reward row count changed")
infra=[index for index,row in enumerate(rows) if row.get("infrastructure_failure") is True]
sandbox_status=[index for index,row in enumerate(rows) if row.get("status") == "sandbox_error"]
if len(infra) != 498 or len(sandbox_status) != 495 or infra[0] // 8 + 1 != 36:
    raise SystemExit("preserved invalid C8 Public infrastructure-failure signature changed")
if any(row.get("infrastructure_failure") is True for row in rows[:35*8]):
    raise SystemExit("preserved invalid C8 Public healthy prefix changed")
if any(
    not isinstance(row.get("failure_counts"), dict) or row["failure_counts"].get("sandbox_error", 0) <= 0
    for row in rows
    if row.get("infrastructure_failure") is True
):
    raise SystemExit("preserved invalid C8 Public infrastructure-failure rows lost sandbox_error evidence")
for step in (50,100):
    checkpoint=public_run / "checkpoints" / f"checkpoint-{step}"
    required=[checkpoint/name for name in (
        "adapter_config.json", "adapter_model.safetensors", "optimizer.pt", "scheduler.pt",
        "rng_state.pth", "trainer_state.json", "training_args.bin",
    )]
    if any(not item.is_file() or item.is_symlink() or item.stat().st_size <= 0 for item in required):
        raise SystemExit(f"preserved invalid C8 Public checkpoint-{step} changed")
    state=json.loads((checkpoint/"trainer_state.json").read_text(encoding="utf-8"))
    if state.get("global_step") != step:
        raise SystemExit(f"preserved invalid C8 Public checkpoint-{step} state changed")
print("preserved_invalid_c8_infrastructure_invalid=PASS first_bad_step=36 infrastructure_failure_rows=498 sandbox_error_status_rows=495 hidden_absent=true")
PY_SUPERSEDED
then
  fail_preflight "preserved invalid C8 infrastructure-failure evidence or preserved invalid Public run changed"
fi
...
from code_verifier.training.grpo import (
    _config_hash,
    _file_hash,
    _latest_valid_resume_checkpoint,
    _paired_definition,
...
if selected is None:
    raise SystemExit("incomplete pilot has no valid Trainer+sidecar checkpoint; preserve it and return to control-plane recovery")
...
run_one() {
  ...
  if ! "$TUNNEL_HELPER" >>"$LOG_FILE" 2>&1; then
    write_evidence 2 125 infrastructure_failed "$mode pilot Piston tunnel is unavailable immediately before train-grpo"
    exit $?
  fi
  printf '[%s] %s pilot Piston tunnel healthy immediately before train-grpo\n' "$(date -u +%Y-%m-%dT%H:%M:%SZ)" "$mode" >>"$LOG_FILE"
...
def checkpoint_inventory(run_dir: Path) -> dict[str, object]:
    ...
    if final_log_state is None:
        raise SystemExit("checkpoint-100 log state is missing")
    for name, expected in final_log_state["logs"].items():
        if _stream_log_file_state(run_dir / name) != expected:
            raise SystemExit(f"checkpoint-100 log boundary is not the complete canonical {name}")
    return {
...
def recovery_history_inventory(run_dir: Path, attempt_count: int) -> list[str]:
    ...
    archive_pattern = re.compile(r"before-attempt-([1-9][0-9]*)-resume-checkpoint-([1-9][0-9]*)")
    incomplete_pattern = re.compile(
        r"\.before-attempt-([1-9][0-9]*)-resume-checkpoint-([1-9][0-9]*)\.incomplete-.+"
    )
    restore_pattern = re.compile(r"\.(rollouts|rewards|group_metrics)\.jsonl\.resume-.+\.tmp")

    def validate_attempt_step(attempt: int, step: int) -> None:
        if attempt < 2 or attempt > attempt_count or step > 100 or step % 10 != 0:
            raise SystemExit("recovery-history entry identity is out of range")

    for entry in sorted(history_root.iterdir()):
        if entry.is_symlink():
            raise SystemExit("recovery-history contains a symlink")
        incomplete_match = incomplete_pattern.fullmatch(entry.name)
        if incomplete_match is not None:
            validate_attempt_step(int(incomplete_match.group(1)), int(incomplete_match.group(2)))
            if not entry.is_dir():
                raise SystemExit("recovery-history incomplete staging entry is not a directory")
            allowed = {*stream_names, "manifest.json"}
            if not {path.name for path in entry.iterdir()} <= allowed:
                raise SystemExit("recovery-history incomplete staging contains unexpected files")
            if any(path.is_symlink() or not path.is_file() for path in entry.iterdir()):
                raise SystemExit("recovery-history incomplete staging contains unsafe files")
            entries.append(entry.name)
            continue
        if restore_pattern.fullmatch(entry.name) is not None:
            if not entry.is_file():
                raise SystemExit("recovery-history restore staging entry is not a file")
            entries.append(entry.name)
            continue
        match = archive_pattern.fullmatch(entry.name)
        if match is None or not entry.is_dir():
            raise SystemExit("recovery-history entry name is invalid")
        attempt = int(match.group(1))
        step = int(match.group(2))
        validate_attempt_step(attempt, step)
        manifest_path = entry / "manifest.json"
        if not manifest_path.is_file() or manifest_path.is_symlink():
            raise SystemExit("recovery-history manifest is missing or unsafe")
        manifest = json.loads(manifest_path.read_text(encoding="utf-8"))
        expected_manifest_fields = {
            "version", "attempt", "resume_checkpoint", "global_step", "before_logs",
            "restored_checkpoint_logs", "superseded_future_checkpoints",
        }
        if not isinstance(manifest, dict) or set(manifest) != expected_manifest_fields:
            raise SystemExit("recovery-history manifest schema is invalid")
        if (
            manifest.get("version") != 1
            or manifest.get("attempt") != attempt
            or manifest.get("resume_checkpoint") != f"checkpoint-{step}"
            or manifest.get("global_step") != step
        ):
            raise SystemExit("recovery-history manifest identity is invalid")
        before_logs = manifest.get("before_logs")
        restored = manifest.get("restored_checkpoint_logs")
        future = manifest.get("superseded_future_checkpoints")
        if not isinstance(before_logs, dict) or set(before_logs) != stream_names:
            raise SystemExit("recovery-history before_logs are invalid")
        if not isinstance(restored, dict) or set(restored) != stream_names:
            raise SystemExit("recovery-history restored checkpoint logs are invalid")
        if not isinstance(future, list) or not all(isinstance(item, str) for item in future):
            raise SystemExit("recovery-history future-checkpoint inventory is invalid")
        for name in stream_names:
            archived_stream = entry / name
            if _stream_log_file_state(archived_stream) != before_logs[name]:
                raise SystemExit(f"recovery-history archived {name} differs from its manifest")
        allowed = {*stream_names, "manifest.json"}
        ...
        if future_root.exists():
            ...
            if not future_root.is_dir() or future_root.is_symlink():
                raise SystemExit("recovery-history future-checkpoint directory is unsafe")
            actual_future = sorted(path.name for path in future_root.iterdir())
            for path in future_root.iterdir():
                future_match = re.fullmatch(r"checkpoint-([1-9][0-9]*)", path.name)
                if (
                    future_match is None
                    or path.is_symlink()
                    or not path.is_dir()
                    or int(future_match.group(1)) <= step
                    or int(future_match.group(1)) > 100
                ):
                    raise SystemExit("recovery-history future-checkpoint entry is invalid")
            if future and actual_future != sorted(future):
                raise SystemExit("completed recovery-history future-checkpoint inventory differs from manifest")
        elif future:
            raise SystemExit("completed recovery-history future-checkpoint inventory is missing")
        if {path.name for path in entry.iterdir()} != allowed:
            raise SystemExit("recovery-history archive contains unexpected files")
        entries.append(entry.name)
    return entries
...
def check_run(run_dir: Path, mode: str, run_id: str) -> dict[str, object]:
    ...
    for index, attempt in enumerate(attempts, 1):
        ...
        if attempt.get("status") == "running" and attempt.get("end_time") is not None:
            raise SystemExit(f"{mode} interrupted attempt end_time invalid")
        attempt_total += hours
...
public = check_run(public_run, "public", "C-public-grpo-pilot100-retry1-seed42")
hidden = check_run(hidden_run, "hidden", "D-hidden-grpo-pilot100-retry1-seed42")
