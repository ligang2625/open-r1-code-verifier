...
OP_ROOT="/home/dzy/wp6d-r1-operator/WP6-d/eb523bc749e9aa4362790c45bbcf4d604ad7e478/sft-b-evaluation/C7"
...
SCRIPT_REL="ai-work/executor/operator/WP6-d/sft-b-evaluation/C7/run.sh"
CHECKPOINT_ID="C7"
...
repair_results = Path(
    ...
    "sft-b-evaluation/C7/output/evaluation/B-sft-formal-seed42/samples/results.jsonl"
)
...
payload = {
    ...
    "repair_output_run_dir": "/home/dzy/wp6d-r1-operator/WP6-d/eb523bc749e9aa4362790c45bbcf4d604ad7e478/sft-b-evaluation/C7/output/evaluation/B-sft-formal-seed42",
...
PY
)" || fail_preflight "cannot parse latest C7 checkpoint provenance"
...
printf '%s\n' "${CHECKPOINT_DIFF[@]}" | grep -Fxq "$SCRIPT_REL" || fail_preflight "checkpoint commit does not contain tracked C7 script"
