...
OP_ROOT="/home/dzy/wp6d-r1-operator/WP6-d/eb523bc749e9aa4362790c45bbcf4d604ad7e478/sft-b-evaluation/C6"
...
SCRIPT_REL="ai-work/executor/operator/WP6-d/sft-b-evaluation/C6/run.sh"
CHECKPOINT_ID="C6"
...
repair_results = Path(
    ...
    "sft-b-evaluation/C6/output/evaluation/B-sft-formal-seed42/samples/results.jsonl"
)
...
payload = {
    ...
    "repair_output_run_dir": "/home/dzy/wp6d-r1-operator/WP6-d/eb523bc749e9aa4362790c45bbcf4d604ad7e478/sft-b-evaluation/C6/output/evaluation/B-sft-formal-seed42",
...
[[ "$PARENT_COMMIT" == "$REVIEW_COMMIT" ]] || fail_preflight "checkpoint parent does not equal committed R1 review"
...
[[ "$(sha256sum "$VERIFY_REPO/uv.lock" | awk '{print $1}')" == "$DEPENDENCY_LOCK_SHA" ]] || fail_preflight "dependency lock SHA mismatch"
...
PY
)" || fail_preflight "cannot parse latest C6 checkpoint provenance"
...
printf '%s\n' "${CHECKPOINT_DIFF[@]}" | grep -Fxq "$SCRIPT_REL" || fail_preflight "checkpoint commit does not contain tracked C6 script"
